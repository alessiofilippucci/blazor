...
public static class ConfigurationBinderExtension
{
    ...
    /// <returns>The new instance of T if successful, default(T) otherwise.</returns>
    public static T Get<T>(this IConfiguration configuration, Action<BinderOptionsExtension> configureOptions, T defaultValue = null) where T : class
    {
    ...
    /// <param name="configureOptions">Configures the binder options.</param>
    /// <returns>The new instance if successful, null otherwise.</returns>
    public static object Get(this IConfiguration configuration, Type type, Action<BinderOptionsExtension> configureOptions)
    {
        if (configuration == null)
        {
            throw new ArgumentNullException(nameof(configuration));
        ...
        var options = new BinderOptionsExtension();
    ...
    public static void BindExtended(this IConfiguration configuration, string key, object instance)
        => configuration.GetSection(key).BindExtended(instance);
    ...
    /// <param name="configuration">The configuration instance to bind.</param>
    /// <param name="instance">The object to bind.</param>
    public static void BindExtended(this IConfiguration configuration, object instance)
        => configuration.BindExtended(instance, o => { });
    ...
    /// <param name="instance">The object to bind.</param>
    /// <param name="configureOptions">Configures the binder options.</param>
    public static void BindExtended(this IConfiguration configuration, object instance, Action<BinderOptionsExtension> configureOptions)
    {
        if (configuration == null)
        {
            throw new ArgumentNullException(nameof(configuration));
    ...
    private static void BindNonScalar(this IConfiguration configuration, object instance, BinderOptionsExtension options)
    {
        if (instance != null)
        {
    ...
    private static void BindProperty(PropertyInfo property, object instance, IConfiguration config, BinderOptionsExtension options)
    {
        ...
        var propertyValue = GetPropertyValue(property, instance, config, options);
    ...
    private static object BindToCollection(TypeInfo typeInfo, IConfiguration config, BinderOptionsExtension options)
    {
    ...
    private static object AttemptBindToCollectionInterfaces(Type type, IConfiguration config, BinderOptionsExtension options)
    {
    ...
    private static object BindInstance(Type type, object instance, IConfiguration config, BinderOptionsExtension options)
    {
    ...
    private static object CreateInstance(Type type)
    {
        ...
        {
            throw new InvalidOperationException("CannotActivateAbstractOrInterface(type)");
        }
        ...
        {
            throw new InvalidOperationException("MissingParameterlessConstructor(type)");
        }
        ...
        {
            throw new InvalidOperationException("FailedToActivate(type)", ex);
        }
    }

    private static void BindDictionary(object dictionary, Type dictionaryType, IConfiguration config, BinderOptionsExtension options)
    {
    ...
    private static void BindCollection(object collection, Type collectionType, IConfiguration config, BinderOptionsExtension options)
    {
    ...
    private static Array BindArray(Array source, IConfiguration config, BinderOptionsExtension options)
    {
    ...
    private static bool TryConvertValue(Type type, string value, string path, out object result, out Exception error)
    {
        ...
        if (converter.CanConvertFrom(typeof(string)))
        {
            ...
            {
                error = new InvalidOperationException("FailedBinding(path, type)", ex);
            }
            return true;
        }
    ...
    private static object GetPropertyValue(PropertyInfo property, object instance, IConfiguration config, BinderOptionsExtension options)
    {
    ...
    private static IEnumerable<string> GetPropertyAttributeNames(MemberInfo property)
    {
        ...
        var a = from attributeData in property.GetCustomAttributesData()
                from argument in attributeData?.ConstructorArguments
                where attributeData.AttributeType == typeof(JsonPropertyNameAttribute)
                where argument.ArgumentType == typeof(string)
                select argument.Value.ToString();
